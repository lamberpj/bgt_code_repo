...
#### LOAD "ALL" ####
df_us_2019 <- fread("./int_data/df_us_2019_standardised.csv", nThread = 16, integer64 = "numeric", select = c("job_id", "country", "state", "city", "wfh_wham", "job_date", "bgt_occ", "month", "employer", "job_id_weight", "job_url")) %>% mutate(country = "US") %>% setDT()
df_us_2020 <- fread("./int_data/df_us_2020_standardised.csv", nThread = 16, integer64 = "numeric", select = c("job_id", "country", "state", "city", "wfh_wham", "job_date", "bgt_occ", "month", "employer", "job_id_weight", "job_url")) %>% mutate(country = "US") %>% setDT()
df_us_2021 <- fread("./int_data/df_us_2021_standardised.csv", nThread = 16, integer64 = "numeric", select = c("job_id", "country", "state", "city", "wfh_wham", "job_date", "bgt_occ", "month", "employer", "job_id_weight", "job_url")) %>% mutate(country = "US") %>% setDT()
df_us_2022 <- fread("./int_data/df_us_2022_standardised.csv", nThread = 16, integer64 = "numeric", select = c("job_id", "country", "state", "city", "wfh_wham", "job_date", "bgt_occ", "month", "employer", "job_id_weight", "job_url")) %>% mutate(country = "US") %>% setDT()
...
colnames(df_us)
df_us <- df_us %>% select(country, state, wfh_wham, dictionary, neg_dictionary, job_date, bgt_occ, month, job_id_weight)
