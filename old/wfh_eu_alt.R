...
#### WFH from DFMs ####
paths_dfm <- list.files("./int_data/wfh_alt", pattern = "wfh_dfmdf_", full.names = T)
paths_dfm
paths_raw_text <- list.files("./int_data/wfh_alt", pattern = "wfh_text_", full.names = T)
...
saveRDS(df_kwic, "./int_data/df_kwic_eu_alt.rds")
...
df_kwic <- readRDS("./int_data/df_kwic_eu_alt.rds")
...
saveRDS(wfh_df, "./int_data/wfh_df_alt.rds")
...
wfh_df <- readRDS("./int_data/wfh_df_alt.rds")

#### Structured ####
paths <- list.files("./bg-eu-bucket/alternative/postings", pattern = ".zip", full.names = T)
paths
paths <- paths[grepl("BE|DE|FR|LU|NL", paths)]
paths
df_stru <- safe_mclapply(1:length(paths), function(i) {
  
  warning(paste0("\nSTART: ",i))
  paths[i]
  system(paste0("unzip '", paths[i],"' -d ./bg-eu-bucket/alternative/postings"))
  csv_path <- paths[i] %>% gsub(".zip", ".csv", .) %>% gsub("./bg-eu-bucket/alternative/postings/indexdata postings |./bg-eu-bucket/alternative/postings/integrative postings ", "", .)
  csv_path
  csv_path <- list.files("./bg-eu-bucket/alternative/postings", pattern = ".csv", full.names = T)[grepl(csv_path, list.files("./bg-eu-bucket/alternative/postings", pattern = ".csv", full.names = T))]
  csv_path
...
save(df_stru, file = "./int_data/df_stru_wfh_eu_alt.RData")
...
p1
ggexport(p1, filename = "./plots/text_based/eu_alt_wfh_level_by_parsing.pdf")
remove(p1)
...
p2 = df_ts_share %>%
  ...
  theme(
    ...
    text = element_text(size = 16))
p2
ggexport(p2, filename = "./plots/text_based/eu_alt_wfh_share_by_parsing_20.pdf")
remove(p2)
...
p2 = df_ts_share %>%
  ...
  theme(
    ...
    text = element_text(size = 16))
p2
ggexport(p2, filename = "./plots/text_based/eu_alt_wfh_share_by_parsing_10.pdf")
remove(p2)
...
p2 = df_ts_share %>%
  ...
  theme(
    ...
    text = element_text(size = 16))
p2
ggexport(p2, filename = "./plots/text_based/eu_alt_wfh_share_by_parsing_5.pdf")
remove(p2)
...
p3
ggexport(p3, filename = "./plots/text_based/eu_alt_wfh_level_by_country.pdf")
remove(p3)
...
p3 = df_levels_country %>%
  ...
  theme(text = element_text(size = 16))
p3
ggexport(p3, filename = "./plots/text_based/eu_alt_wfh_share_by_country_20.pdf")
remove(p3)
...
p3 = df_levels_country %>%
  ...
  theme(text = element_text(size = 16))
p3
ggexport(p3, filename = "./plots/text_based/eu_alt_wfh_share_by_country_10.pdf")
remove(p3)
...
p3 = df_levels_country %>%
  ...
  theme(text = element_text(size = 16))
p3
ggexport(p3, filename = "./plots/text_based/eu_alt_wfh_share_by_country_5.pdf")
remove(p3)
...
p4 = df_levels_country %>%
  ...
  theme(text = element_text(size = 16))
p4
ggexport(p4, filename = "./plots/text_based/eu_alt_wfh_index_count_by_country_20.pdf")
remove(p4)
...
p4 = df_levels_country %>%
  ...
  theme(text = element_text(size = 16))
p4
ggexport(p4, filename = "./plots/text_based/eu_alt_wfh_index_count_by_country_10.pdf")
remove(p4)
...
p4 = df_levels_country %>%
  ...
  theme(text = element_text(size = 16))
p4
ggexport(p4, filename = "./plots/text_based/eu_alt_wfh_index_share_by_country_10.pdf")
remove(p4)
...
p4 = df_levels_country %>%
  ...
  theme(text = element_text(size = 16))
p4
ggexport(p4, filename = "./plots/text_based/eu_alt_wfh_index_share_by_country_5.pdf")
remove(p4)
...
p3 = df_levels_esco1 %>%
  ...
  theme(text = element_text(size = 16))
p3
ggexport(p3, filename = "./plots/text_based/eu_alt_wfh_level_by_esco1.pdf")
remove(p3)
...
p3 = df_levels_esco1 %>%
  ...
  theme(text = element_text(size = 16))
p3
ggexport(p3, filename = "./plots/text_based/eu_alt_wfh_share_by_esco1_20.pdf")
remove(p3)
...
p3 = df_levels_esco1 %>%
  ...
  theme(text = element_text(size = 16))
p3
ggexport(p3, filename = "./plots/text_based/eu_alt_wfh_share_by_esco1_10.pdf")
remove(p3)
...
p3 = df_levels_esco1 %>%
  ...
  theme(text = element_text(size = 16))
p3
ggexport(p3, filename = "./plots/text_based/eu_alt_wfh_share_by_esco1_5.pdf")
remove(p3)
...
p4 = df_levels_esco1 %>%
  ...
  theme(text = element_text(size = 16))
p4
ggexport(p4, filename = "./plots/text_based/eu_alt_wfh_index_count_by_esco1_20.pdf")
remove(p4)
...
p4 = df_levels_esco1 %>%
  ...
  theme(text = element_text(size = 16))
p4
ggexport(p4, filename = "./plots/text_based/eu_alt_wfh_index_count_by_esco1_10.pdf")
remove(p4)
...
p4 = df_levels_esco1 %>%
  ...
  theme(text = element_text(size = 16))
p4
ggexport(p4, filename = "./plots/text_based/eu_alt_wfh_index_share_by_esco1_10.pdf")
remove(p4)
...
p4 = df_levels_esco1 %>%
  ...
  theme(text = element_text(size = 16))
p4
ggexport(p4, filename = "./plots/text_based/eu_alt_wfh_index_share_by_esco1_5.pdf")
remove(p4)
...
p3 = df_levels_telework %>%
  ...
  theme(text = element_text(size = 16))
p3
ggexport(p3, filename = "./plots/text_based/eu_alt_wfh_level_by_telework.pdf")
remove(p3)
...
p3 = df_levels_telework %>%
  ...
  theme(text = element_text(size = 16))
p3
ggexport(p3, filename = "./plots/text_based/eu_alt_wfh_share_by_telework_20.pdf")
remove(p3)
...
p3 = df_levels_telework %>%
  ...
  theme(text = element_text(size = 16))
p3
ggexport(p3, filename = "./plots/text_based/eu_alt_wfh_share_by_telework_10.pdf")
remove(p3)
...
p3 = df_levels_telework %>%
  ...
  theme(text = element_text(size = 16))
p3
ggexport(p3, filename = "./plots/text_based/eu_alt_wfh_share_by_telework_5.pdf")
remove(p3)
...
p4 = df_levels_telework %>%
  ...
  theme(text = element_text(size = 16))
p4
ggexport(p4, filename = "./plots/text_based/eu_alt_wfh_index_count_by_telework_20.pdf")
remove(p4)
...
p4 = df_levels_telework %>%
  ...
  theme(text = element_text(size = 16))
p4
ggexport(p4, filename = "./plots/text_based/eu_alt_wfh_index_count_by_telework_10.pdf")
remove(p4)
...
p4 = df_levels_telework %>%
  ...
  theme(text = element_text(size = 16))
p4
ggexport(p4, filename = "./plots/text_based/eu_alt_wfh_index_share_by_telework_10.pdf")
remove(p4)
...
p4 = df_levels_telework %>%
  ...
  theme(text = element_text(size = 16))
p4
ggexport(p4, filename = "./plots/text_based/eu_alt_wfh_index_share_by_telework_5.pdf")
remove(p4)
...
table(df_stru$later_quarters)

# 1. Compare Quarter Dummies using different FEs

# 1.1 Run Regressions
regs_wfh <- lapply(1:4, function(i) {
  if(i == 1) {lm <- feols(wfh_non_neg ~ later_quarters | month, df_stru %>% filter(!is.na(idregion) & idregion != "" & !is.na(idesco_level_4) & idesco_level_4 != ""), cluster = ~ year_month, lean = T)}
  if(i == 2) {lm <- feols(wfh_non_neg ~ later_quarters | month + idesco_level_4, df_stru %>% filter(!is.na(idregion) & idregion != "" & !is.na(idesco_level_4) & idesco_level_4 != ""), cluster = ~ year_month, lean = T)}
  if(i == 3) {lm <- feols(wfh_non_neg ~ later_quarters | month + idregion, df_stru %>% filter(!is.na(idregion) & idregion != "" & !is.na(idesco_level_4) & idesco_level_4 != ""), cluster = ~ year_month, lean = T)}
  if(i == 4) {lm <- feols(wfh_non_neg ~ later_quarters | month + idregion + idesco_level_4, df_stru %>% filter(!is.na(idregion) & idregion != "" & !is.na(idesco_level_4) & idesco_level_4 != ""), cluster = ~ year_month, lean = T)}
  warning("\n\n############# ",i," #############\n\n")
  return(lm)
})
...
# 1.3 Stack Data
for_plot_long_wfh <- bind_rows(for_plot_wfh[[1]] %>% mutate(FEs = "Month"),
                               for_plot_wfh[[2]] %>% mutate(FEs = "Month + ESCO4"),
                               for_plot_wfh[[3]] %>% mutate(FEs = "Month + Region"),
                               for_plot_wfh[[4]] %>% mutate(FEs = "Month + ESCO4 + Region"))
# 1.4 Plot
p1 = for_plot_long_wfh %>%
  ...
  ggtitle("Coefficient Plot of WFH in EU (Alt)") +
  ...
  labs(subtitle = paste0("n = ",format(obs, big.mark=",")),
       caption = "Note: Using BGT EU (Alt) (BE, DE, FR, LU, NL).\n+/- 2 SD in dark grey.") +
  theme(
    axis.title.x=element_blank(),
    legend.position="bottom",
    legend.title = element_blank(),
  ...
  theme(text = element_text(size = 16))
p1
ggexport(p1, filename = "./plots/text_based/eu_alt_wfh_coeff_plot_10.pdf")
remove(p1)
...
p1 = for_plot_long_wfh %>%
  ...
  theme(text = element_text(size = 16))
p1
ggexport(p1, filename = "./plots/text_based/eu_alt_wfh_coeff_plot_5.pdf")
remove(p1)
...
p1 = for_plot_long_wfh %>%
  ...
  theme(text = element_text(size = 16))
p1
ggexport(p1, filename = "./plots/text_based/eu_alt_wfh_coeff_plot_3.pdf")
remove(p1)
...
# 2.1 Run Regressions
regs_wfh <- lapply(1:5, function(i) {
  if(i == 1) {lm <- feols(wfh_non_neg ~ later_quarters | month + idregion + idesco_level_4, df_stru %>% filter(idcountry == "BE"), cluster = ~ year_month, lean = T)}
  if(i == 2) {lm <- feols(wfh_non_neg ~ later_quarters | month + idregion + idesco_level_4, df_stru %>% filter(idcountry == "DE"), cluster = ~ year_month, lean = T)}
  if(i == 3) {lm <- feols(wfh_non_neg ~ later_quarters | month + idregion + idesco_level_4, df_stru %>% filter(idcountry == "FR"), cluster = ~ year_month, lean = T)}
  if(i == 4) {lm <- feols(wfh_non_neg ~ later_quarters | month + idregion + idesco_level_4, df_stru %>% filter(idcountry == "LU"), cluster = ~ year_month, lean = T)}
  if(i == 5) {lm <- feols(wfh_non_neg ~ later_quarters | month + idregion + idesco_level_4, df_stru %>% filter(idcountry == "NL"), cluster = ~ year_month, lean = T)}
  warning("\n\n############# ",i," #############\n\n")
  return(lm)
})
# 2.2 Make Plots
for_plot_wfh <- lapply(1:5, function(i) {
  regs_wfh[[i]]$coeftable %>%
    as_tibble %>%
    mutate(estimate = Estimate, lb = (Estimate - 2*`Std. Error`), ub = (Estimate + 2*`Std. Error`)) %>%
    select(estimate, lb, ub) %>%
...
for_plot_long_wfh_country <- bind_rows(for_plot_wfh[[1]] %>% mutate(Country = "BE"),
                                       for_plot_wfh[[2]] %>% mutate(Country = "DE"),
                                       for_plot_wfh[[3]] %>% mutate(Country = "FR"),
...
p1 = for_plot_long_wfh_country %>%
  ...
  theme(text = element_text(size = 16))
p1
ggexport(p1, filename = "./plots/text_based/eu_alt_wfh_coeff_plot_by_country_10.pdf")
remove(p1)
...
p1 = for_plot_long_wfh_country %>%
  ...
  theme(text = element_text(size = 16))
p1
ggexport(p1, filename = "./plots/text_based/eu_alt_wfh_coeff_plot_by_country_5.pdf")
remove(p1)
...
p1 = for_plot_long_wfh_country %>%
  ...
  theme(text = element_text(size = 16))
p1
ggexport(p1, filename = "./plots/text_based/eu_alt_wfh_coeff_plot_by_country_3.pdf")
remove(p1)
...
fwrite(df_stru_ag, "./int_data/eu_alt_wfh_ag_df.csv")
