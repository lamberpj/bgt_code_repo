...
p1
ggexport(p1, filename = "./plots/text_based/us_wfh_level_by_parsing_sr.pdf")
remove(p1)
...
p2 = df_ts_share %>%
  ...
  theme(
    ...
    text = element_text(size = 16))
p2
ggexport(p2, filename = "./plots/text_based/us_wfh_share_by_parsing_20_sr.pdf")
remove(p2)
...
p2 = df_ts_share %>%
  ...
  theme(
    ...
    text = element_text(size = 16))
p2
ggexport(p2, filename = "./plots/text_based/us_wfh_share_by_parsing_10_sr.pdf")
remove(p2)
...
p2 = df_ts_share %>%
  ...
  theme(
    ...
    text = element_text(size = 16))
p2
ggexport(p2, filename = "./plots/text_based/us_wfh_share_by_parsing_5_sr.pdf")
remove(p2)
...
p3
ggexport(p3, filename = "./plots/text_based/us_wfh_level_by_country_sr.pdf")
remove(p3)
...
p3 = df_levels_region %>%
  ...
  theme(text = element_text(size = 16))
p3
ggexport(p3, filename = "./plots/text_based/us_wfh_share_by_country_20_sr.pdf")
remove(p3)
...
p3 = df_levels_region %>%
  ...
  theme(text = element_text(size = 16))
p3
ggexport(p3, filename = "./plots/text_based/us_wfh_share_by_country_10_sr.pdf")
remove(p3)
...
p3 = df_levels_region %>%
  ...
  theme(text = element_text(size = 16))
p3
ggexport(p3, filename = "./plots/text_based/us_wfh_share_by_country_5_sr.pdf")
remove(p3)
...
p4 = df_levels_region %>%
  ...
  theme(text = element_text(size = 16))
p4
ggexport(p4, filename = "./plots/text_based/us_wfh_index_count_by_country_20_sr.pdf")
remove(p4)
...
p4 = df_levels_region %>%
  ...
  theme(text = element_text(size = 16))
p4
ggexport(p4, filename = "./plots/text_based/us_wfh_index_count_by_country_10_sr.pdf")
remove(p4)
...
p4 = df_levels_region %>%
  ...
  theme(text = element_text(size = 16))
p4
ggexport(p4, filename = "./plots/text_based/us_wfh_index_share_by_country_10_sr.pdf")
remove(p4)
...
p4 = df_levels_region %>%
  ...
  theme(text = element_text(size = 16))
p4
ggexport(p4, filename = "./plots/text_based/us_wfh_index_share_by_country_5_sr.pdf")
remove(p4)
...
p3 = df_levels_esco1 %>%
  ...
  theme(text = element_text(size = 16))
p3
ggexport(p3, filename = "./plots/text_based/us_wfh_level_by_esco1_sr.pdf")
remove(p3)
...
p3 = df_levels_esco1 %>%
  ...
  theme(text = element_text(size = 16))
p3
ggexport(p3, filename = "./plots/text_based/us_wfh_share_by_esco1_20_sr.pdf")
remove(p3)
...
p3 = df_levels_esco1 %>%
  ...
  theme(text = element_text(size = 16))
p3
ggexport(p3, filename = "./plots/text_based/us_wfh_share_by_esco1_10_sr.pdf")
remove(p3)
...
p3 = df_levels_esco1 %>%
  ...
  theme(text = element_text(size = 16))
p3
ggexport(p3, filename = "./plots/text_based/us_wfh_share_by_esco1_5_sr.pdf")
remove(p3)
...
p4 = df_levels_esco1 %>%
  ...
  theme(text = element_text(size = 16))
p4
ggexport(p4, filename = "./plots/text_based/us_wfh_index_count_by_esco1_20_sr.pdf")
remove(p4)
...
p4 = df_levels_esco1 %>%
  ...
  theme(text = element_text(size = 16))
p4
ggexport(p4, filename = "./plots/text_based/us_wfh_index_count_by_esco1_10_sr.pdf")
remove(p4)
...
p4 = df_levels_esco1 %>%
  ...
  theme(text = element_text(size = 16))
p4
ggexport(p4, filename = "./plots/text_based/us_wfh_index_share_by_esco1_10_sr.pdf")
remove(p4)
...
p4 = df_levels_esco1 %>%
  ...
  theme(text = element_text(size = 16))
p4
ggexport(p4, filename = "./plots/text_based/us_wfh_index_share_by_esco1_5_sr.pdf")
remove(p4)
...
p3 = df_levels_telework %>%
  ...
  theme(text = element_text(size = 16))
p3
ggexport(p3, filename = "./plots/text_based/us_wfh_level_by_telework_sr.pdf")
remove(p3)
...
p3 = df_levels_telework %>%
  ...
  theme(text = element_text(size = 16))
p3
ggexport(p3, filename = "./plots/text_based/us_wfh_share_by_telework_20_sr.pdf")
remove(p3)
...
p3 = df_levels_telework %>%
  ...
  theme(text = element_text(size = 16))
p3
ggexport(p3, filename = "./plots/text_based/us_wfh_share_by_telework_10_sr.pdf")
remove(p3)
...
p3 = df_levels_telework %>%
  ...
  theme(text = element_text(size = 16))
p3
ggexport(p3, filename = "./plots/text_based/us_wfh_share_by_telework_5_sr.pdf")
remove(p3)
...
p4 = df_levels_telework %>%
  ...
  theme(text = element_text(size = 16))
p4
ggexport(p4, filename = "./plots/text_based/us_wfh_index_count_by_telework_20_sr.pdf")
remove(p4)
...
p4 = df_levels_telework %>%
  ...
  theme(text = element_text(size = 16))
p4
ggexport(p4, filename = "./plots/text_based/us_wfh_index_count_by_telework_10_sr.pdf")
remove(p4)
...
p4 = df_levels_telework %>%
  ...
  theme(text = element_text(size = 16))
p4
ggexport(p4, filename = "./plots/text_based/us_wfh_index_share_by_telework_10_sr.pdf")
remove(p4)
...
p4 = df_levels_telework %>%
  ...
  theme(text = element_text(size = 16))
p4
ggexport(p4, filename = "./plots/text_based/us_wfh_index_share_by_telework_5_sr.pdf")
remove(p4)
